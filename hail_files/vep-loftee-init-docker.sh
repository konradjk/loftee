...
export VEP_DOCKER_IMAGE=konradjk/vep85_loftee:0.1
...
gsutil cp gs://gnomad-resources/loftee-beta/vep85-loftee-gcloud.json /vep_data/vep85-gcloud.json
gsutil -m cp -r gs://gnomad-resources/loftee-beta/loftee_data/${ASSEMBLY}/* /vep_data/loftee_data/ &
...
gsutil cp gs://gnomad-resources/loftee-beta/1var.vcf file:///1var.vcf
